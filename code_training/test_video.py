...
def main():
    ...
    # path = 'data/caltech002/query/airplanes/image_0704.jpg'
    # path = 'data/vq/query/video001/image_19.jpg'
    path = 'data/v_cars/query/honda/image_3706_q.jpg'
    ...
    index_helper.save_topk_retrieved_images('retrieved_images/v_cars/', index_result_info[0], 5, gallery_info)
